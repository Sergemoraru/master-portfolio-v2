...
const Contact = () => (
    <div>
        <div className="flex flex-col pt-32">
            <h1 className='flex flex-row mt-48 justify-center pt-10 text-5xl font-bold text-center text-slate-500'>Contact</h1>
        </div>
        ...
        <div className="isolate bg-white px-6 py-10 sm:py-10 lg:px-8">
            ...
            <div className="mx-auto max-w-2xl text-center">
                <p className="text-lg leading-8 text-gray-600">
                    I would love to hear from you! <br></br> Please fill out the form below and I will get back to you as soon as possible.
                </p>
            </div>
            <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
                ...
                <div className="mt-10">
                    <button
                        type="submit"
                        className="block w-full rounded-md bg-sky-600 px-3.5 py-2.5 text-center text-sm font-semibold 
                        text-white shadow-sm hover:bg-sky-500 focus-visible:outline 
